...
duration = st.slider("Training for (minutes):", 15, 180, 60, step=15)

# Auto-assign zone based on workout
workout_zone_map = {
    "Push": "Free Weights",
    "Pull": "Machines",
    "Legs": "Squat Racks",
...
if st.button("Submit"):
    if not name or not gym_id:
        ...
        st.success(f"✅ Thank you {name}! Head to the **{gym_zone}** and pick up your **{wristband_colour}** wristband.")
